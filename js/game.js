...
async function intrude() {
    ...
    await fetch(`${BASE_URL}/api/sessions/${sessionId}/intrude`, {
        method: 'POST',
...
async function abandon() {
    ...
    await fetch(`${BASE_URL}/api/sessions/${sessionId}/abandon`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
            currSystem,
...
async function breakCone() {
    ...
    await fetch(`${BASE_URL}/api/sessions/${sessionId}/break_cone`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
async function victoryCone() {
    ...
    await fetch(`${BASE_URL}/api/sessions/${sessionId}/victory_cone`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ game, players })
    });
...
async function save420GamePhoto() {
    if (capturedImage) {
        await fetch(`${BASE_URL}/api/sessions/${sessionId}/upload`, {
            method: 'POST',
            headers: {
...
async function generateTeamResults() {
    ...
    if (currTeams.length == 2) {
        ...
        const res = await fetch(`${BASE_URL}/api/tournament/${currTournamentId}/results`);
...
async function submitMatchResult(tournamentId, matchId, winnerId, scores) {
    ...
    await fetch(`${BASE_URL}/api/tournament/${tournamentId}/update`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
async function saveGameState(incomplete) {
    try {
        ...
        await fetch(`${BASE_URL}/api/sessions/${sessionId}/save`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
            theGame: theGame,
